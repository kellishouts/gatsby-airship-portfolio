          ...
          <div className="block">
            <div className="project-section">
              ...
              <div className="image-box">
                <img className="small-image" src={launchIllustrationBackground} alt="How do you get executives to role-play a SciFi game?" />
              ...
              <div className="image-box image-box-timeline">
                <img className="small-image" src={launchTimelineBoth} alt="Software Development vs. Launch Timeline" />
              </div>
          ...
          <div className="block">
            <div className="project-section">
              ...
              <div className="image-box image-box-large">
                <img className="large-image" src={launchSketchesWide} alt="Initial UI Sketches" />
              ...
              <div className="image-box image-box-large">
                <img className="large-image" src={launchFlowchartGameElements} alt="Flowchart - Game Elements" />
              ...
              <div className="image-box">
                <img className="small-image" src={launchIllustrationInitialScenario} alt="How we imagined it would feel to play our imaginary SciFi scenario." />
                <p className="caption">How we imagined it would feel to play our imaginary SciFi scenario.</p>
              </div>
              <div className="image-box">
                <img className="small-image" src={launchIllustrationUIMockups} alt="Early game UI mockups" />
              ...
              <div className="image-box">
                <img className="medium-image" src={launchSpreadsheet} alt="A snippet of the game economy and logic mapped out on a spreadsheet." />
        ...
        <div className="container very-light-grey-container">
          <div className="block">
            <div className="project-section">
              ...
              <div className="image-box">
                <img className="medium-image" src={launchPaperMockups} alt="Digital components converted to a paper prototype for the first user test session." />
                <p className="caption">Digital components converted to a paper prototype for the first user test session.</p>
              </div>

              <h4>Test Group A</h4>
              <div className="image-box image-box-timeline">
                <img className="small-image" src={launchTimeline03Test} alt="Timeline - Step 03: Test Group A" />
              </div>
              ...
              <div className="image-box image-box-photo">
                <img className="medium-image" src={launchPhotoGroupA2} alt="Thank you Alan, Laura, Te, Jen, and Justin!" />
                <p className="caption">Thank you Alan, Laura, Te, Jen, and Justin!</p>
              </div>
              <div className="image-box image-box-photo">
                <img className="medium-image" src={launchPhotoGroupA1} alt="Paper prototypes and repurposed board game tokens used during the first play test." />
        ...
        <div className="container white-container">
          <div className="block">
            <div className="project-section">
              ...
              <div className="image-box image-box-large">
                <img className="large-image" src={launchSketchV1} alt="Version 1 Sketch mockups." />
              ...
              <h4>Test Group B</h4>
              <div className="image-box image-box-timeline">
                <img className="small-image" src={launchTimeline05Test} alt="Timeline - Step 05: Test Group B" />
              </div>
              ...
              <div className="image-box image-box-photo">
                <img className="medium-image" src={launchPhotoGroupB1} alt="Thank you Brandon, Bob, Sean, and Manny!" />
              ...
              <div className="image-box image-box-photo">
                <img className="medium-image" src={launchPhotoGroupB3} alt="Tokens were used for planning ahead and allocating resources." />
              ...
              <div className="image-box image-box-photo">
                <img className="medium-image" src={launchPhotoGroupB2} alt="Players spent 10 minutes organizing cards. This was not an intended behavior." />
        ...
        <div className="container very-light-grey-container">
          <div className="block">
            <div className="project-section">
              ...
              <div className="image-box image-box-large">
                <img className="large-image" src={launchSketchV2} alt="Four separate user flows were simplified to a single flow in the game UI." />
              ...
              <h4>Test Group C</h4>
              <div className="image-box image-box-timeline">
                <img className="small-image" src={launchTimeline07Test} alt="Timeline - Step 07: Test" />
              </div>
              ...
              <div className="image-box image-box-photo">
                <img className="medium-image" src={launchPhotoGroupC1} alt="Thank you Justin, Nix, Carlos, Jake and Aaron!" />
                <p className="caption">Thank you Justin, Nix, Carlos, Jake and Aaron!</p>
              </div>
              <div className="image-box image-box-photo">
                <img className="medium-image" src={launchPhotoGroupC2} alt="Color strips improved Question Cards, but colored probes still confused players." />
        ...
        <div className="container white-container">
          <div className="block">
            <div className="project-section">
              ...
              <div className="image-box">
                <img className="medium-image" src={launchPhotoGameAssets} alt="Final game UI and professionally printed cards and instruction insert." />
        ...
        <div className="container very-light-grey-container">
          <div className="block">
            <div className="project-section">
              ...
              <div className="image-box image-box-timeline">
                <img className="small-image" src={launchTimeline10Launch} alt="Timeline - Step 10: Launch" />
              </div>
              ...
              <div className="image-box image-box-large">
                <img className="large-image" src={launchPhotoConference1} alt="In each group, participants organized game materials differently." />
              ...
              <div className="image-box image-box-photo">
                <img className="medium-image" src={launchPhotoConference2} alt="Participants generally had an enjoyable experience." />
              ...
              <div className="image-box image-box-large">
                <img className="large-image" src={launchPhotoConference3} alt="The game scaled easily to 100-person conference." />
        ...
        <div className="container white-container">
          <div className="block">
            <div className="project-section">
              ...
              <div className="image-box">
                <img className="small-image" src={launchIllustrationChaosVsCollaboration} alt="Chaos vs. Collaboration" />
